...
### Reach for instead
- **feature-section** — when you're past the opening statement and need to break down specific product capabilities.
- **announcement-banner** — when the message is a small, dismissible update, not the page's primary opening statement.
