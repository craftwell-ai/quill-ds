...
### Reach for instead
- **select** — when the list is short (≤20) and doesn't need search — Select is less markup and less wiring.
- **native-select** — when you want the OS-native picker instead — no search, no custom popup.
