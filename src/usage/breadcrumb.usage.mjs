export const usage = {
  name: 'breadcrumb',
  kind: 'component',
  summary: 'A trail of links showing the current page\'s position in a hierarchy — the last crumb is always the current, non-link page.',
  useWhen: [
  ...
  alternatives: [
    { name: 'page-header', when: 'you need the breadcrumb bundled with a title, description, and page actions in one header block, not just the trail by itself.' },
  ],
  rules: [
    {
      id: 'last-item-is-page-not-link',
      do: 'Render the final crumb as BreadcrumbPage (plain, non-link, current) — every earlier crumb as BreadcrumbLink.',
      dont: 'Make every crumb, including the current page, a clickable BreadcrumbLink — you can\'t navigate to where you already are.',
      visual: true,
    },
    {
      id: 'ellipsis-past-four-levels',
      do: 'Swap the middle crumbs for BreadcrumbEllipsis once the path goes past about 4 levels deep.',
      dont: 'Render every level of a very deep path — the trail wraps and stops reading as a quick way back up.',
      visual: false,
    },
  ],
  a11y: [
