...
// Searchable gallery of the whole Material Symbols Outlined library.
// Type to search; click an icon to see its detail (sizes + usage snippet).
// Rendered on the "Foundations / Icons" doc page and exercised by the story test.
